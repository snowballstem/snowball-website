...
var IndonesianStemmer = function() {
    ...
    /** @return {boolean} */
    function r_VOWEL() {
        if (!(base.in_grouping(g_vowel, 97, 117))) return false;
        return true;
    };

    /** @return {boolean} */
    function r_KER() {
        if (!(base.out_grouping(g_vowel, 97, 117))) return false;
        if (!(base.eq_s("er"))) return false;
        return true;
    };
        ...
        lab2: {
            ...
            lab3: {
                ...
                lab4: {
                    ...
                    base.cursor = v_8;
                    if (I_measure <= 2) break lab4;
                    if (!r_remove_second_order_prefix()) break lab4;
                }
                base.cursor = v_7;
                base.cursor = v_6;
                break lab2;
