...
var RussianStemmer = function() {
    ...
    /** @const */ var /** Array<number> */ g_v = [33, 65, 8, 232];
    ...
    function r_mark_regions() {
        ...
        lab0: {
            ...
            base.cursor++;
            I_pV = base.cursor;
            if (!base.go_in_grouping(g_v, 1072, 1103)) break lab0;
            base.cursor++;
            if (!base.go_out_grouping(g_v, 1072, 1103)) break lab0;
            base.cursor++;
            if (!base.go_in_grouping(g_v, 1072, 1103)) break lab0;
        ...
        lab0: {
            while(true) {
                ...
                lab1: {
                    ...
                    if (!base.slice_from("\u0435")) return false;
                    continue;
                }
                base.cursor = v_2;
                break;
        ...
        lab4: {
            lab5: {
                ...
                lab8: {
                    ...
                    lab10: {
                        if (!r_verb()) break lab10;
                        break lab8;
                    }
                    base.cursor = base.limit - v_8;
                    if (!r_noun()) break lab4;
                }
            }
        }
